...
* @returns {any}
*/
export function runDataPipeline(pipe_ids, input_data, configs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.runDataPipeline(retptr, addHeapObject(pipe_ids), addHeapObject(input_data), addHeapObject(configs));
...
* @returns {any}
*/
export function getSourcePipes(configs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.getSourcePipes(retptr, addHeapObject(configs));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
* @returns {any}
*/
export function getRootSources(configs, endpoint) {
    const ptr0 = passStringToWasm0(endpoint, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.getRootSources(addHeapObject(configs), ptr0, len0);
...
export function __wbg_log_cc1e77f6f0c98c0e(arg0, arg1) {
